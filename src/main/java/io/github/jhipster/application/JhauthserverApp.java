...
public class JhauthserverApp {

    private static final Logger log = LoggerFactory.getLogger(JhauthserverApp.class);

    private final Environment env;

    public JhauthserverApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhauthserver.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhauthserverApp.class);
